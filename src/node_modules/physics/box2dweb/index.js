...
var ARROW_STICK_IMPULSE_TOLERANCE = 0.0035;
...
listener.PostSolve = function(contact, impulse) {
	...
	if(bodyArrow.GetUserData() === 'arrow' && bodyTarget.GetUserData() === 'test' && impulse.normalImpulses[0] > ARROW_STICK_IMPULSE_TOLERANCE) {
