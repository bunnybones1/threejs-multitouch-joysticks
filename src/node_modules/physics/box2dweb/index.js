...
listener.PostSolve = function(contact, impulse) {
    ...
    if(bodyArrow.GetUserData() === 'arrow' && bodyTarget.GetUserData() === 'test') {
    	var meshArrow = bodyArrow.bodyMesh;
    	var meshTarget = bodyTarget.bodyMesh;
    	if(meshArrow && meshTarget) {
    		despawnBody(bodyArrow, true);
    		meshArrow.body = null;
    		bodyArrow.mesh = null;

    		THREE.SceneUtils.attach(meshArrow, world.scene, meshTarget);
    	}
    }
}
...
function despawnBody(body, keepInScene) {
	...
	index = bodyMeshesWithManualRotationUpdate.indexOf(body.bodyMesh);
	if(index !== -1) {
