...
function init(world) {
	...
	exports.registerTeleportee = registerTeleportee;
	exports.deregisterTeleportee = deregisterTeleportee;
	delete exports.init;
}
...
function preRender() {
	var dx = _world.centerDelta.x;
	var dy = _world.centerDelta.y;
