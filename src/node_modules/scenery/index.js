...
function init() {
	...
	//Right now Pool is super tied to a number of assets - do you think we create a seperate pool for 
	//each scenery item? or one pool of all scenery items. We may have to define some settings for 
	//each object to find them in the array if the later.


	//Also, we should tie a function to make a non active item invisible.

	pool.init(200, "test");

	placeItems(scene, 200);
...
function preRender() {
	...
	//console.log('preRender', pool.poolees);
	pool.poolees.forEach(function(item) {
