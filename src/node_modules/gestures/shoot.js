...
function updateMesh(mesh) {
	...
	var deltaX = (mesh.x - mesh.originX) * view.width;
	var deltaY = (mesh.y - mesh.originY) * view.height;
...
function onStart(touches) {
	...
	meshes[id].originX = x / view.width;
	meshes[id].originY = y / view.height;
