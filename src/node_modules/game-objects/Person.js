...
function Person(params) {
	...
	this.addBox(30, 20, 40, 0, 0, 0, colors.darkslateblue);
	this.addBox(45, 35, 40, 0, 0, 40, params.color);
	this.addBox(30, 30, 30, 0, 0, 80, colors.tan, colors.red);
	this.addBox(10, 50, 10, 25, 20, 50, colors.tan, colors.red);
	this.addBox(10, 50, 10, -25, 20, 50, colors.tan, colors.red);
	//face
	this.addBox(10, 10, 10, 0, 20, 80, colors.tan, colors.red);
	this.addBox(3, 3, 3, -10, 16.5, 90, colors.blue);
	this.addBox(3, 3, 3, 10, 16.5, 90, colors.blue);
