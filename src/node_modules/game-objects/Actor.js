...
function Actor(params) {
	...
	var mesh = this.getMesh(params);
	this.mesh = mesh;
	params.mesh = mesh;
	this.body = physics.createPhysicsBody(params);
	this.fixture = this.body.GetFixtureList();
	this.body.SetUserData(this);
	this.isWeapon = params.isWeapon;
	this.isPerson = params.isPerson;
	this.team = params.team;
}

Actor.prototype.getMesh = function(params) {
	return new THREE.Mesh(this.getGeometry(params.radius), params.material);
};
