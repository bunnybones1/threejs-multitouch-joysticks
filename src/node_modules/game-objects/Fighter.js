...
Fighter.prototype.death = function() {
	var mesh = this.mesh;
	this.weapons.forEach(function(weapon) {
		physics.queueDespawnBody(weapon.body);
		THREE.SceneUtils.attach(weapon.mesh, world.scene, mesh);
	});
	Person.prototype.death.call(this);
};
...
Fighter.prototype.updateWalk = function() {
	...
	this.weapons.forEach(function(weapon, i){
		if(target && targetIsCloseEnough) {
			...
			if(weapon.isAttacking && weapon.joint.GetJointTranslation() > 0) {
				body.ApplyTorque(0.01 * ((i%2) * -2 + 1));
			}
