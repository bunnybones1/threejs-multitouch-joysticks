...
Hero.prototype.updateWalk = function() {
	...
	this.walkForce.x = clamp(this.desiredLocation.x - currLocation.x, -this.maxSpeed, this.maxSpeed);
	this.walkForce.y = clamp(this.desiredLocation.y - currLocation.y, -this.maxSpeed, this.maxSpeed);	
