...
function Hero(params) {
	...
	var min = new THREE.Vector3(-300, -300, -300);
	this.minOffset = min.clone();
	var max = new THREE.Vector3(300, 300, 300);
...
Hero.prototype.getClosestInterestingThing = function() {
	return physics.getClosestEnemyBody(this.body.GetPosition(), 0.15);
};
