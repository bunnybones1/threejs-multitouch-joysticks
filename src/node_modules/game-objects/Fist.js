...
function Fist(params) {
	...
	this.pushBack = params.pushBack;
	this.damageBase = params.damageBase;
	this.damageRange = params.damageRange;
...
Fist.prototype.getMesh = function(params) {
...
Fist.prototype.getDamage = function() {
	return this.damageBase + Math.random() * this.damageRange;
};
